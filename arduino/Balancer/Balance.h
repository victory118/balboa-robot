...
const int16_t DISTANCE_RESPONSE = 40;
...
const int16_t DISTANCE_DIFF_RESPONSE = -30;
...
const int16_t SPEED_RESPONSE = 1500;
...
// Variables for printing to serial monitor
const int16_t DEBUG_TIME_MS = 1000;
void balanceDebug();
